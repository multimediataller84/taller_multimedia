...
export default function InvoiceModal({ open, maxAmount, onClose, onConfirm }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="bg-white rounded-2xl p-6 w-[360px] shadow-xl">
        <h3 className="font-Lato text-lg mb-4">Agregar factura</h3>
        ...
        <form onSubmit={handleSubmit(submit)} className="space-y-4">
          <div>
            ...
            <input
              ...
              {...register("amount", {
                ...
                validate: (v) => {
                  ...
                  if (Number(v) > maxAmount) return "max";
                  return true;
                }
              })}
            />
            ...
            {errors.amount?.type === "max" && (
              <span className="text-red-600 mt-2 text-sm">El monto excede el crédito disponible</span>
            )}
          </div>
