        ...
        <div className="flex flex-col w-full bg-gray3">
            <div className="w-full flex flex-col">
              <div className="flex w-full justify-between items-center pt-2 md:pt-4 2xl:pt-8">
                <h2 className="font-Lato text-xs sm:text-sm md:text-base xl:text-base 2xl:text-2xl pl-8">Añadir Cliente</h2>
              ...
              <div className="flex flex-col w-full">
                <div className="flex w-full text-xs sm:text-base mt-2 2xl:mt-8 space-y-4 font-lato font-medium">
