...
export default function addProfile (props: addProfileProps){
  ...
  useEffect(() => {
    ...
    props.setClientSelect((prev: any) => {
      ...
      return {
        ...base,
        credit_enabled: base?.credit_enabled ?? false,
        credit_unlimited: base?.credit_unlimited ?? false,
        credit_limit:
          base?.credit_unlimited ? null :
          (typeof base?.credit_limit === "number" ? base.credit_limit : 0),
      };
    });
  }, [props.visibleAdd, props.setClientSelect]);
          ...
          <div className="flex space-x-8 pr-4">
            <button
              className={`w-[94px] py-2 rounded-3xl font-Lato font-bold transition duration-300  ${
                props.add
                  ? "bg-blue-500 text-white hover:bg-blue-800 hover:border-blue-800"
            ...
            <button
              className="w-[94px] py-2 rounded-3xl bg-white border border-gray2 hover:bg-gray2 hover:border-gray2 text-gray1 font-Lato font-bold transition duration-300 "
              onClick={onCancel}
            >
              Cancelar
            </button>
        ...
        {moveBar === 0 && (
          <form className="flex-col flex font-Lato pt-8 pl-8 space-y-4">
            ...
            <div className="flex flex-col space-y-4">
              ...
              <input
                className="w-[472px] h-[34px] border rounded-2xl px-4 text-gray1 border-gray2 bg-white font-medium text-base focus:outline-blue-500 focus:outline-2"
                type="text"
                id="name"
                name="name"
            ...
            <div className="flex flex-col space-y-4">
              ...
              <textarea
                className="w-[472px] min-h-[96px] max-h-[132px] border rounded-2xl px-4 text-gray1 border-gray2 bg-white font-medium text-base focus:outline-blue-500 focus:outline-2 pt-2"
                id="direccion"
                name="address"
